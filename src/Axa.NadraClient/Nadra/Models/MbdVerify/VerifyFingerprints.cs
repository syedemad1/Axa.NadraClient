...
namespace Axa.NadraClient.Nadra.Models.MbdVerify
{
    public class MbdVerifyFingerprintsRequest
    {
        public MbdVerifyFingerprintsRequest(string requesterTranId, string customerCnic, string customerMsisdn, int fingerIndex, string fingerTemplate, TemplateTypes templateType, string areaName, string deviceImei, string contactNumber, int latitude, int longitude, string? nadraTranId, string? sessionId)
        {
    ...
    public class MbdVerifyFingerprintsResponse
    {
